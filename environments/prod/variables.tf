...
variable "ecr_keep_last_images" { type = number default = 20 }
...
variable "service_min_capacity" { type = number default = 2 }
variable "service_max_capacity" { type = number default = 6 }
...
variable "django_allowed_hosts" { type = string default = "*" }
